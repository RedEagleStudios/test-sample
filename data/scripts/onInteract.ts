...
import { autoTameDrone } from "./onSpawn.ts";
import { ActionFormData } from "@minecraft/server-ui";
import { dragonMeleeAttack } from "./meleeDamage.ts";

function getDroneOwner(drone: Entity): Player | null {
...
export function showDragonControl(player: Player, dragon: Entity): void {
