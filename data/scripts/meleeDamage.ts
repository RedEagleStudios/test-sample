import { world, EntityDamageCause, Entity, Player } from "@minecraft/server";
...
interface MeleeAttackResult {
    success: boolean;
    hitCount: number;
    hitEntities: HitEntity[];
    error?: string;
}
 ...
 */
export function dragonMeleeAttack(dragon: Entity, rider: Player | null = null): MeleeAttackResult {
    try {
 ...
 */
export function dragonMeleeAttackSimple(dragon: Entity, rider: Player | null = null): MeleeAttackResult {
    try {
