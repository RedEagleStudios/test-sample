    ...
    try {
        ...
        for (const rider of dragonRiders) {
            ...
            if (yawData.isLookingLeft) {
                rider.onScreenDisplay.setActionBar(`§dLooking Left §7(${yawData.yawDifference.toFixed(1)}°)`);
            ...
            if (yawData.isLookingRight) {
                rider.onScreenDisplay.setActionBar(`§bLooking Right §7(${yawData.yawDifference.toFixed(1)}°)`);
